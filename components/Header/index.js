    ...
    <header className="md:flex md:items-center md:justify-between p-4 pb-0 shadow-lg md:pb-4 border-gray-200">
      <div className="flex items-center justify-between mb-4 md:mb-0">
        <h1 className="leading-none text-2xl text-greyDarkest">
          <a
            className="no-underline text-greyDarkest hover:text-black"
            href="#"
          >
      ...
      <nav className="md:mr-8">
        <ul className="list-reset md:flex md:items-center">
          <li className="md:ml-4">
            <Link href={"/"}>
              <a className="block no-underline hover:underline py-2 text-greyDarkest hover:text-purple md:border-none md:p-0">
                Home
              </a>
            </Link>
          </li>
          <li className="md:ml-4">
            <Link href={"/codigo_de_conducta"}>
              <a className="border-t block no-underline hover:underline py-2 text-greyDarkest hover:text-purple md:border-none md:p-0">
                Codigo de conducta
              </a>
            </Link>
          </li>
          ...
          <li>
            <Link href="/login">
              <button className="md:ml-4 bg-transparent hover:bg-blue-500  text-purple hover:text-greyDarkest py-2 px-4 border border-purple hover:border-transparent rounded-full">
                Ingresar
              </button>
            </Link>
          </li>
