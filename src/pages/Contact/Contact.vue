          ...
          <v-form v-model="valid" ref="form">
            ...
            <v-flex class="form__btns">
              ...
              <v-btn
                ...
                round
                color="deep-purple lighten-1"
                class="btns__singlebtn"
                @click="clear"
              >Limpiar</v-btn>
            </v-flex>
          </v-form>
          <div class="tarjeta__redes">
            <a href="https://twitter.com/ArProgramando?lang=es" target="_blank">
              <Icons propName="twitter" bgcolor="#7e64ab" color="#ffffff"></Icons>
            </a>
            <a href="https://www.linkedin.com/" target="_blank">
              <Icons propName="linkedin" bgcolor="#7e64ab" color="#ffffff"></Icons>
            </a>
            <a href="https://github.com/chicasprogramando" target="_blank">
              <Icons propName="github" bgcolor="#7e64ab" color="#ffffff"></Icons>
            </a>
          </div>
        </div>
      </div>
