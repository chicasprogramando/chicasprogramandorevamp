<template>
    <div class="svg-circle"> 
        <div v-if="twitter" class="svg-icon">
        ...
        <div v-if="instagram" class="svg-icon instagram-icon">
        ...
        <div v-if="github" class="svg-icon github-icon">
        ...
        <div v-if="linkedin" class="svg-icon linkedin-icon">
